...
export default function Main() {
    ...
    // setIngredients re-runs the entire component when it is called which updates ingredientList when ingredients is changed
    ...
    return (
        <main>
            ...
            {ingredientList.length > 0 && <section className="main-section">
            ...
            {recipeShown && <section className="recipe-container">
